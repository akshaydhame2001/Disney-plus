...
function MovieCard({ movie }: { movie: Movie }) {
  return (
    <div className="shrink-0  cursor-pointer transform hover:scale-105 transition duration-200 ease-out hover:drop-shadow-lg">
      <Link href={`/movie/${movie.id}?movie=${movie.title}`}>
